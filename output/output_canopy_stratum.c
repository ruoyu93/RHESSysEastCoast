							  ...
							  FILE *outfile)
{
	...
	fprintf(outfile,
		...
		patchID,
		stratum[0].ID,
		zone[0].rain, // start of %lf 1
		patch[0].rain_throughfall,  // 10
		...
		stratum[0].mult_conductance.LWP,  // 30
